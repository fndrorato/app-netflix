...
def show_reviews():
    ...
    selected_movie_title = st.selectbox('Selecione o filme', list(movie_titles.keys()))
    ...
    comment = st.text_area('Comentário do Filme')
    ...
    if st.button('Cadastrar'):
        ...
        if new_review:
            ...
            st.error('Erro ao cadastrar o comentário. Verifique os dados.')
